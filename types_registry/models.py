...
class QuestionType(models.Model):
    ...
    subtypes_table = models.ForeignKey(ContentType, unique=True, related_name='question_types1')  # TODO: mozno premenovat na subtypes_config_table
    params_table = models.ForeignKey(ContentType, unique=True, related_name='question_types2')
